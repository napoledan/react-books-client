...
const BookList = () => {
  ...
  const booksWithCovers = books.map((singleBook) => { // Map over the books array and return a new array with the cover image URL
    return {
      ...singleBook,
  ...
  if(loading){  // Check if the loading state variable is true
